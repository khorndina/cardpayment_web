...
class VendorProductVariantItemController extends Controller
{
    ...
    public function index(VendorProductVariantItemDataTable $dataTable, $productid, $variantid)
    {
        ...
        // dd($productVariant);
        return $dataTable->with('variantId', $variantid)->render('vendor.product.product-variant-item.index', compact('product', 'productVariant'));
    }

    /**Show create page to user when user click create button on index page */
    ...
    public function edit(string $variantItemId)
    {
        ...
        // dd($product);
        return view('vendor.product.product-variant-item.edit', compact('productVariant', 'product', 'productVariantItem'));
