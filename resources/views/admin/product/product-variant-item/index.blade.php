              ...
              <div class="col-12">
                <div class="card">
                  <div class="card-header">
                    <h4>List All Product Variant-Item</h4>
                    <div class="card-header-action"><a href="{{ route('admin.product-variant-item.create', ['productid'=>$product->id, 'variantId'=>$productVariant->id]) }}" class="btn btn-primary">+ Create New</a></div>
                  </div>
                  <div class="card-body">
                    {{$dataTable->table()}}
                  </div>
...
@push('scripts')
  ...
  <script>
    $(document).ready(function(){
        ...
        $.ajax({
                url: "{{route('admin.product-variant-item.changestatus')}}",
                method: 'PUT',
                data:{
                    ischecked:ischecked,
                    id:id
