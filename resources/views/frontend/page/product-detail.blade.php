                            ...
                            <div class="exzoom hidden" id="exzoom">
                                <div class="exzoom_img_box">
                                    ...
                                    <ul class='exzoom_img_ul'>
                                        <li><img class="zoom ing-fluid w-100" src="{{ asset($product->thum_image) }}" alt="product"></li>
                                        @foreach($product->productImageGalleries as $productImageGallery)
                                            <li><img class="zoom ing-fluid w-100" src="{{ asset($productImageGallery->image) }}" alt="product"></li>
                                        @endforeach
                                    </ul>
                                </div>
                                    ...
                                    <div class="col-xl-6 col-sm-6">
                                        ...
                                        <select class="select_2" name="state">
                                            @foreach ($variant->productVariantItems as $productVariantItem)
                                                <option {{$productVariantItem->is_default == 1 ? 'selected' : ''}}>{{$productVariantItem->name}} (${{$productVariantItem->price}})</option>
                                            @endforeach
                                        </select>
                                    </div>
                                    @endforeach
                                ...
                                <div class="tab-pane fade" id="pills-contact" role="tabpanel"
                                    ...
                                    <div class="wsus__pro_det_vendor">
                                        <div class="row">
                                            ...
                                            <div class="col-xl-12">
                                                <div class="wsus__vendor_details"> {{$product->vendor->description}}</div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
