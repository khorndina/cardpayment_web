                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        <ul>
                            ...
                            <li><a href="javascript:;">Flas Sale</a></li>
                        </ul>
                    </div>
                </div>
            </div>
                    ...
                    @endphp
                        <div class="col-xl-3 col-sm-6 col-lg-4">
                            <div class="wsus__product_item">
                                ...
                                @endif
                                <a class="wsus__pro_link" href="{{ route('product-detail.showProduct', $product->slug) }}">
                                    <img src="{{ asset($product->thum_image) }}" alt="product" class="img-fluid w-100 img_1" />
                                ...
                                <div class="wsus__product_details">
                                    ...
                                    <a class="wsus__pro_name" href="{{ route('product-detail.showProduct', $product->slug) }}">{{$product->name}}</a>
                                    @if (checkDiscount($product))
                                        <p class="wsus__price">{{$generalSetting->currency_icon}} {{$product->offer_price}}<del>{{$generalSetting->currency_icon}} {{$product->price}}</del></p>
                                    @else
                                        <p class="wsus__price">{{$generalSetting->currency_icon}} {{$product->price}}</p>
                                    @endif
                                ...
                                <div class="row modal_slider">
                                    <div class="col-xl-12">
                                        <div class="modal_slider_img">
                                            <img src="{{ asset($product->thum_image) }}" alt="{{$product->name}}" class="img-fluid w-100">
                                        </div>
                                    </div>

                                    {{-- if product dont have imagegallery --}}
                                    ...
                                    @foreach($product->productImageGalleries as $productImageGallery)
                                        <div class="col-xl-12">
                                            <div class="modal_slider_img">
                                                <img src="{{ asset($productImageGallery->image) }}" alt="{{$product->name}}" class="img-fluid w-100">
                                            </div>
                                        </div>
                                    @endforeach
                                </div>
