<div class="dashboard_sidebar">
    ...
    <a href="{{ route('home') }}" class="dash_logo"><img src="{{ asset('frontend/images/aba-logo.png') }}" alt="logo" class="img-fluid"></a>
    <ul class="dashboard_link">
        ...
        <li><a href="{{ route('vendor.products.index') }}"><i class="fab fa-product-hunt"></i>Product</a></li>
        <li><a href="{{ route('vendor.shop-profile.index') }}"><i class="fal fa-gift-card"></i> Shop Profile</a></li>
